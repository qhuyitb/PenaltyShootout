    ...
    private void handleRegister(Message message) {
        try {
            ...
            if (credentials == null || credentials.length < 2) {
                sendMessage(new Message("register_failure", "Dữ liệu không hợp lệ"));
                System.out.println("✗ Đăng ký thất bại: Dữ liệu không hợp lệ");
                return;
            }
            ...
            if (username == null || username.trim().isEmpty()) {
                sendMessage(new Message("register_failure", "Tên đăng nhập không được để trống"));
                return;
            }
            
            if (password == null || password.trim().isEmpty()) {
                sendMessage(new Message("register_failure", "Mật khẩu không được để trống"));
                return;
            }
            ...
            if (!username.matches("^[a-zA-Z0-9_]+$")) {
                sendMessage(new Message("register_failure", 
                    "Tên đăng nhập chỉ được chứa chữ cái, số và dấu gạch dưới"));
                return;
            }
            
            // Thực hiện đăng ký qua DatabaseManager
            ...
            if (success) {
                ...
                System.out.println("✗ Đăng ký thất bại: Tên đăng nhập '" + username + "' đã tồn tại");
                sendMessage(new Message("register_failure", 
